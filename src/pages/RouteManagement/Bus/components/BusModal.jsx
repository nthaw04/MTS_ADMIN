                    ...
                    <div className="space-y-6">
                        <div>
                            ...
                            <input
                                ...
                                className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors ${errors.busNumber ? 'border-red-500' : 'border-gray-300'
                                    }`}
                                    ...
                                    {formData.terminalId.map((terminalId) => {
                                        ...
                                        return terminal ? (
                                            ...
                                            >
                                                ...
                                                <button
                                                    type="button"
                                                    onClick={() => handleTerminalChange(terminalId, false)}
